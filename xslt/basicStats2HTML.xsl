<xsl:stylesheet version="2.0" xmlns:tei="http://www.tei-c.org/ns/1.0"
  ...
  <xsl:template match="/">
      ...
      <head>
	      <title>Godwin Diary: Basic Statistics for <xsl:value-of select="$typePhrase"/> Mentioned</title>
 ...
 var plot = $.plot($("#placeholder"),
	 ...
	 //     axis coordinates for other axes, if present, are in pos.x2, pos.x3, ...
      ...
      <body>
	      ...
	      <h2>Mentions of <xsl:value-of select="$typePhrase"/> by Year</h2>
	      <div id="placeholder" style="width:550px;height:250px">
		      ...
		      <span>  </span> 
			      ...
			      <p>
				      ...
				      Instances of <xsl:value-of select="$typePhrase"/> recorded in the diary a total of <xsl:value-of select="$numMentions"/> times.
			      </p>
		      ...
		      <div>
			      ...
			      <p>Subdivisions of <xsl:value-of select="$typePhrase"/> include: 
				      <xsl:choose>
